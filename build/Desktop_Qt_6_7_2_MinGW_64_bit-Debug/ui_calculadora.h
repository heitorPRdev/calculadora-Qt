...
public:
    ...
    void setupUi(QMainWindow *calculadora)
    {
        ...
        ldtext->setMaximumSize(QSize(253, 16777215));
        QFont font1;
        font1.setFamilies({QString::fromUtf8("Arial")});
        font1.setPointSize(20);
        ldtext->setFont(font1);
        ...
        btnlimp->setFont(font1);

        horizontalLayout->addWidget(btnlimp);

        layoutWidget1 = new QWidget(centralwidget);
        layoutWidget1->setObjectName("layoutWidget1");
        layoutWidget1->setGeometry(QRect(20, 100, 341, 331));
    ...
    void retranslateUi(QMainWindow *calculadora)
    {
        ...
        btnmult->setText(QCoreApplication::translate("calculadora", "*", nullptr));
